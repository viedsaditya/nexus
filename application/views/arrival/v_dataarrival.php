                        ...
                        foreach ($arrival as $key => $value) { ?>
                            <tr>
                                ...
                                <?php if ($value->arr_status == 'OPERATED') { ?>
                                    <td data-toggle="modal" data-target="#updateModal<?php echo $value->arr_id ?>" style='text-align:center; color:#0CAD19; font-weight: 600;'><div class="nprinsley-detaxt"><?= $value->arr_status ?></div></td>
                                <?php } else { ?>
