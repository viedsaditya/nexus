    ...
    <div class="col-lg-6">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                echo form_open_multipart('seasondeparture/generate_season');
                ?>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="dep_season" id="seasonSummer" value="Summer" required>
                                <label class="form-check-label" for="seasonSummer">Summer</label>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="dep_season" id="seasonWinter" value="Winter" required>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col">
                            <label class="control-label" for="dep_start_date">START</label>
                            <input type="date" name="dep_start_date" value="<?= set_value('dep_start_date'); ?>" class="form-control" placeholder="" id="dep_start_date" required>
                        </div>
                        <div class="col">
                            <label class="control-label" for="dep_end_date">END</label>
                            <input type="date" name="dep_end_date" value="<?= set_value('dep_end_date'); ?>" class="form-control" placeholder="" id="dep_end_date" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label class="control-label" for="dep_time">STD (hh:mm)</label>
                    <input type="time" name="dep_time" value="<?= set_value('dep_time'); ?>" class="form-control" placeholder="" id="dep_time" required>
                </div>
                <div class="form-group">
                    <!-- <div class="row">
                        <div class="col">
                ...
                <label class="control-label mb-0 mt-1" for="dep_date">DOP</label>
                <hr>
                <?php
                $day = [ 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
                foreach ($day as $d) {
                    echo '<label>';
                    echo '<input class="form-check form-check-inline" type="checkbox" name="dep_date[]" value="' . $d . '"> ' . $d;
                    echo '</label><br>';
                }
                ?>
                <br>
    ...
    <div class="col-lg-6">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('seasondeparture/generate_season_excel'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="form-label">SEASON</label>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="dep_season_excel" id="seasonSummerExcel" value="Summer" required>
                                    <label class="form-check-label" for="seasonSummerExcel">Summer</label>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="dep_season_excel" id="seasonWinterExcel" value="Winter" required>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col">
                                <label class="control-label" for="dep_start_date_excel">START</label>
                                <input type="date" name="dep_start_date_excel" value="<?= set_value('dep_start_date_excel'); ?>" class="form-control" placeholder="" id="dep_start_date_excel" required>
                            </div>
                            <div class="col">
                                <label class="control-label" for="dep_end_date_excel">END</label>
                                <input type="date" name="dep_end_date_excel" value="<?= set_value('dep_end_date_excel'); ?>" class="form-control" placeholder="" id="dep_end_date_excel" required>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    document.getElementById("dep_start_date").onchange = function () {
        var input = document.getElementById("dep_end_date");
        input.min = this.value;
    }

    document.getElementById("dep_start_date_excel").onchange = function () {
        var input = document.getElementById("dep_end_date_excel");
        input.min = this.value;
    }
