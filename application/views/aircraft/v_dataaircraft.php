...
<div class="card shadow mb-4 mt-3">
    <div class="card-header py-3">
        ...
        <a href="<?= base_url('aircraft/input'); ?>" class="btn btn-warning btn-sm btn-icon-split" style="background-color: #F26522;">
            <span class="icon text-white-50">
                <i class="fas fa-plus"></i>
            </span>
            <span class="text">Add Aircraft</span>
        </a>
    </div>
    <div class="card-body">
                    ...
                    foreach ($aircraft as $key => $value) { ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="<?= base_url('aircraft/edit/' . $value->id_ac) ?>" class="btn btn-warning btn-sm" style="background-color: #F26522;">
