    ...
    <div class="col-lg-6">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                echo form_open_multipart('station/edit/' . $station->id_sts);
                ?>

                <!-- inputan data -->
                <div class="form-group">
                    <label class="control-label" for="code_station">Code Station</label>
                    <input type="text" name="code_station" value="<?= $station->code_station ?>" class="form-control" placeholder="Masukan code station" id="code_station">
                </div>
                <div class="form-group">
                    <label class="control-label" for="name_station">Name Station</label>
                    <input type="text" name="name_station" value="<?= $station->name_station ?>" class="form-control" placeholder="Masukan name station" id="name_station">
                </div>
                <div class="form-group">
                    <label class="control-label" for="country">Country</label>
                    <input type="text" name="country" value="<?= $station->country ?>" class="form-control" placeholder="Masukan country" id="country">
                </div>
